...
describe('classifyPitchers', () => {
	...
	it('classifies modern era pitchers with closer', () => {
		const pitchers: ExtendedPitcherStats[] = [
			...
			// Setup man (high quality, short outings)
			{ id: 'setup', name: 'Setup', handedness: 'R', throws: 'R', teamId: 'team1', games: 60, gamesStarted: 0, completeGames: 0, saves: 5, inningsPitched: 60, whip: 1.10, era: 2.80, avgBfpAsStarter: null, avgBfpAsReliever: 4.5, rates: { vsLeft: { single: 0.18, double: 0.04, triple: 0.01, homeRun: 0.02, walk: 0.07, hitByPitch: 0.01, strikeout: 0.25, groundOut: 0.18, flyOut: 0.14, lineOut: 0.04, popOut: 0.03, sacrificeFly: 0, sacrificeBunt: 0, fieldersChoice: 0, reachedOnError: 0, catcherInterference: 0 }, vsRight: { single: 0.18, double: 0.04, triple: 0.01, homeRun: 0.02, walk: 0.07, hitByPitch: 0.01, strikeout: 0.25, groundOut: 0.18, flyOut: 0.14, lineOut: 0.04, popOut: 0.03, sacrificeFly: 0, sacrificeBunt: 0, fieldersChoice: 0, reachedOnError: 0, catcherInterference: 0 } } },
			// Setup man #2
			{ id: 'setup2', name: 'Setup2', handedness: 'R', throws: 'R', teamId: 'team1', games: 55, gamesStarted: 0, completeGames: 0, saves: 3, inningsPitched: 55, whip: 1.15, era: 3.00, avgBfpAsStarter: null, avgBfpAsReliever: 4, rates: { vsLeft: { single: 0.19, double: 0.04, triple: 0.01, homeRun: 0.02, walk: 0.07, hitByPitch: 0.01, strikeout: 0.23, groundOut: 0.18, flyOut: 0.14, lineOut: 0.04, popOut: 0.03, sacrificeFly: 0, sacrificeBunt: 0, fieldersChoice: 0, reachedOnError: 0, catcherInterference: 0 }, vsRight: { single: 0.19, double: 0.04, triple: 0.01, homeRun: 0.02, walk: 0.07, hitByPitch: 0.01, strikeout: 0.23, groundOut: 0.18, flyOut: 0.14, lineOut: 0.04, popOut: 0.03, sacrificeFly: 0, sacrificeBunt: 0, fieldersChoice: 0, reachedOnError: 0, catcherInterference: 0 } } },
			// Long reliever (lower quality, long outings)
